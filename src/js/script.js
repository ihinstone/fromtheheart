...
/* harmony import */ var _modules_catalogFilters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/catalogFilters */ "./src/js/modules/catalogFilters.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js");
/* harmony import */ var _modules_goldHover__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/goldHover */ "./src/js/modules/goldHover.js");
/* harmony import */ var _modules_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/item */ "./src/js/modules/item.js");
/* harmony import */ var _modules_maps__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/maps */ "./src/js/modules/maps.js");
...
/* harmony import */ var _modules_seoText__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/seoText */ "./src/js/modules/seoText.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_item__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_maps__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_goldHover__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_seoText__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_cart__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_catalogFilters__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
...
var cart = function cart() {
  try {
    ...
    var changeTotal = function changeTotal() {
      var allEditions = document.querySelectorAll('.edition__count'),
    ...
    cartItem.forEach(function (item) {
      item.addEventListener('click', function (e) {
        var itemPrice = item.querySelector('.cart__item-price'),
        ...
        if (e.target.parentNode.classList.contains('cart__item-clear')) {
          ...
          var _items = document.querySelectorAll('.cart__item');
...
/***/ "./src/js/modules/catalogFilters.js":
/*!******************************************!*\
  !*** ./src/js/modules/catalogFilters.js ***!
  \******************************************/
/*! exports provided: default */
...
var catalogFilters = function catalogFilters() {
  try {
    $("#slider-range").slider({
      range: true,
      min: 0,
...
/* harmony default export */ __webpack_exports__["default"] = (catalogFilters);
...
var goldHover = function goldHover() {
  try {
    var _goldHover = document.querySelectorAll('[data-hover]');

    _goldHover.forEach(function (item, i) {
...
/* harmony default export */ __webpack_exports__["default"] = (goldHover);

/***/ }),

/***/ "./src/js/modules/item.js":
/*!********************************!*\
  !*** ./src/js/modules/item.js ***!
  \********************************/
/*! exports provided: default */
...
var item = function item() {
  try {
    ...
    var itemDescrTrigger = document.querySelector('.giftset__descr > span'),
    ...
    var giftSetForm = document.querySelector('.giftset__form');
    ...
    var tab = document.querySelectorAll('.giftinfo__nav-item'),
...
var maps = function maps() {
  try {
    var addressItem = document.querySelectorAll('.address__item'),
        addressMap = document.querySelectorAll('.address__maps-item');
    addressItem.forEach(function (item, i) {
      item.addEventListener('click', function () {
        for (var _i = 0; _i < addressItem.length; _i++) {
          addressItem[_i].classList.remove('address__item-active');
        }
...
var menu = function menu() {
  try {
    ...
    var formS = document.querySelector('.searchfield'),
    ...
    if (srcWidth > 768) {
      var cart = document.querySelector('.navigation__cart'),
      ...
      $('[data-menu="catalog"]:first').on('click', function () {
        $('[data-menu="catalog"]:eq(1)').fadeToggle('slow');
      });
      $('[data-menu="services"]:first').on('click', function () {
        $('[data-menu="services"]:eq(1)').fadeToggle('slow');
      });

      var activateMenu = function activateMenu(trigger, target, classToAdd) {
        document.querySelector("".concat(trigger)).addEventListener('click', function () {
          document.querySelector("".concat(target)).classList.add("".concat(classToAdd));
        });
      };

      var deactivateMenu = function deactivateMenu(trigger, target, classToRemove) {
        document.querySelector("".concat(trigger)).addEventListener('click', function () {
          document.querySelector("".concat(target)).classList.remove("".concat(classToRemove));
        });
      };
...
var modal = function modal() {
  ...
  try {
    var showModal = function showModal(trigger, modal) {
      var clicked = document.querySelector(".".concat(trigger));
      clicked.addEventListener('click', function () {
        document.querySelector('.overlay').style.display = 'block';
        document.querySelectorAll('.popup').forEach(function (item) {
          item.style.display = 'none';
        });
        $(".".concat(modal)).fadeIn('slow');
        $(".".concat(modal)).find('input').focus();
      });
      var close = $(".".concat(modal)).find('.close');
      close.on('click', function () {
        $(".".concat(modal)).fadeOut();
        $('.overlay').fadeOut();
      });
...
var seoText = function seoText() {
  try {
    // SeoText Main
    var describeText = document.querySelectorAll('.describe__text'),
        describeForm = document.querySelector('.describe__form');
    describeText[1].style.display = 'none';
    var opened = false;
    describeText.forEach(function (item) {
      item.addEventListener('click', function () {
        if (!opened) {
...
/* harmony default export */ __webpack_exports__["default"] = (seoText);
